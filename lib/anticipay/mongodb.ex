defmodule Anticipay.MongoDB do
  ...
  def create_index(collection_name, index_keys) do
    Mongo.run_command(Anticipay.MongoDB,
  ...
  defp connection_database(:prod), do: "anticipay"
  defp connection_database(env), do: "anticipay_#{env}"
end
