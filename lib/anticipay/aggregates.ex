defmodule Anticipay.Aggregates do
  use GenServer
  ...
  defp spawn_aggregate(nil, id, module) do
    {:ok, pid} = Anticipay.Aggregate.start_link(id, module)
    {pid, pid}
  end
end
