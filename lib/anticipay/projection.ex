defmodule Anticipay.Projection do
  use GenServer
  ...
  def events_where(module, where_clause, limit \\ 0) do
    ...
    Anticipay.EventStore.events_where(where_clause, to_filter(events), limit)
  end
  ...
  def handle_info(:process, state) do
    ...
    events = Anticipay.EventStore.events_where({:offset_after, state.offset}, state.filter)
